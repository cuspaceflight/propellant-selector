...
class Vehicle(object):
    def __init__(self, propellant_mix, material, pressurant, diameter):
        ...
        # Tank volume that must be gas - change if current thinking changes,
...
pressurants = [
    Pressurant("helium", 0.004, 1.66),
    Pressurant("nitrogen", 0.028, 1.40),
    Pressurant("carbon-dioxide", 0.044, 1.29),
]
